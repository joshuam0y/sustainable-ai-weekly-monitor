...
def evaluate_article(client, title, source):
    ...
    prompt = (
        ...
        "footprint of data centers and AI more broadly, and Northeastern University's own "
        "sustainability/AI work -- NOT general AI business news, market/investor sentiment, or data "
        "center construction/capacity stories that don't substantively address environmental impact "
        "or emissions.\n\n"
        "Based only on this headline, reply with exactly two lines, nothing else:\n"
        "ON_TOPIC: yes or no -- \"yes\" only if the environmental/sustainability/emissions angle is "
        "clearly the article's main point, not just a keyword that happens to appear. A story about "
        "AI infrastructure investment, grid capacity, or data center business news is NOT on-topic "
        "just because it mentions energy or data centers.\n"
